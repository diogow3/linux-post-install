...
# upd = update all
alias upd='sudo apt update; sudo apt dist-upgrade -y; flatpak update -y; sudo upgrade brew; sudo apt autoremove -y; sudo apt autoclean'
...
# alt ls
alias ll='ls -AFlv --group-directories-first'
